...
BAD_PATTERNS = [
    ...
    rf"\b{PREFIX}на(хуй|хуя|хуярився|хуйнувся|єбнувся|єбнулась|дрочився|дрочив|хуярились|хуяримся|хуярилися|хуярили|хуячим|хуячимся|дрочим|дрочимо|дрочили|пиздила|пиздили|пиздився|пиздівся|бнувся|бнулися|бнулась|бнулася|бнувся|бнулись|бнулася|бнулась){SUFFIX}\b",
    ...
    rf"\b{PREFIX}по(хуярили|хуячим|дрочим|хуярим|хуяримо|дрочили|дрочимо|хуячимся|пиздився|хуячили){SUFFIX}",
]
